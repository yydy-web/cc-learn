---
title: Java 工具链集成全景
description: 'Java/Spring Boot 开发中 ECC、Gstack、Superpowers、CodeGraph、Graphify、Serena、Spec-Kit、Context7 的完整集成指南'
---
...
│             │   │             │   │             │   │             │   │             │
│ CodeGraph   │   │ Spec-Kit    │   │ Superpowers │   │ Gstack      │   │ Gstack      │
│ Serena      │   │ Gstack      │   │ ECC         │   │ Serena      │   │ CI/CD       │
│ Context7    │   │             │   │ CodeGraph   │   │ ECC         │   │ Hooks       │
└─────────────┘   └─────────────┘   └─────────────┘   └─────────────┘   └─────────────┘
```
...
| Spec-Kit    | [Spec-Kit 规格驱动开发](/guide/advanced/spec-kit)   |
| CodeGraph   | [CodeGraph 代码智能](/guide/advanced/codegraph)     |
| Graphify    | [Graphify 知识图谱](/guide/advanced/graphify)       |
