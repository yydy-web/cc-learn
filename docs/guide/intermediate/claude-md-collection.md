...
description: 收集 GitHub 上高质量、可复制的 CLAUDE.md 模板和最佳实践，包含 Golden CLAUDE.md、Karpathy 原则型、极简模板和全栈项目模板，覆盖多种技术栈和使用场景
---
...
**🎯 学习产出：** 了解社区优秀 CLAUDE.md 配置集合，能借鉴最佳实践优化自己的项目配置
