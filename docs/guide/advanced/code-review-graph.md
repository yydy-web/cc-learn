...
## 与 CodeGraph、Graphify 的对比

[CodeGraph](/guide/advanced/codegraph) 和 [Graphify](/guide/advanced/graphify) 是另外两个基于代码图谱的工具。三者都通过 MCP 为 Claude Code 提供代码理解能力，但设计重点不同：
...
:::tip
更多三工具详细对比、差异分析和兼容性说明，请参考[代码图谱工具对比](/guide/advanced/code-graph-tools)。
:::
