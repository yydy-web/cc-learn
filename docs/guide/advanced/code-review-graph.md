...
[CodeGraph](/guide/advanced/codegraph)、[Graphify](/guide/advanced/graphify) 和 [GitNexus](/guide/advanced/gitnexus) 是另外几个基于代码图谱的工具。四者都通过 MCP 为 Claude Code 提供代码理解能力，但设计重点不同：
