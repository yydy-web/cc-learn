...
**🎯 学习产出：** 掌握智能体路由策略，能独立通过 AGENTS.md 协议解决多框架冲突和定义职责边界
...
- [OpenSpec + Superpowers 双层规划](/guide/advanced/sdd/openspec-superpowers) — 双层规划工作流
- [SDD 方法论与工具辨析](/guide/advanced/sdd/sdd-guide) — SDD 三层模型和工具选择
- [最佳实践](/tips/best-practices) — 四阶段工作流和业务场景

## 下一步

- [SDD 方法论与工具辨析](/guide/advanced/sdd/sdd-guide) — 理解 SDD、OpenSpec、Spec-Kit、Superpowers 的关系
