---
title: 自定义技能
description: 创建、编写和使用自定义 Skills 扩展 Claude Code 的能力——从文件结构、Skill 格式到最佳实践，系统掌握技能扩展机制
---
...
**🎯 学习产出：** 掌握自定义技能开发，能独立创建、编写和部署团队专属的 Skills
...
:::tip
这两个 Skill 解决了 OpenSpec + Superpowers 协同开发中的 5 个常见踩坑。详见[双框架踩坑指南](/guide/advanced/sdd/openspec-superpowers-pitfalls)。
:::
