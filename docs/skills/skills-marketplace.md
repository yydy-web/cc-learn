...
:::tip
本页属于[技能系统](/skills/)的一部分。想从零开始创建自己的 Skills？请参考[自定义技能](/skills/custom-skills)。
:::
...
[Context7](/skills/context7) 提供了 `ctx7` CLI 工具用于 Skills 管理：
...
- [Superpowers 插件](/skills/superpowers) — 结构化开发工作流
